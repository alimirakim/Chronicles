...
Revision ID: aab03e0063a2
Revises: eed892fd23d1
Create Date: 2020-12-03 23:00:30.430011
...
revision = 'aab03e0063a2'
down_revision = 'eed892fd23d1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('character_ranks',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('character_id', sa.Integer(), nullable=False),
    ...
    op.create_table('character_statuses',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('character_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('character_statuses')
    op.drop_table('character_ranks')
